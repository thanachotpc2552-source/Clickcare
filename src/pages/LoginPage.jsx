...
const DEMO_ACCOUNTS = [
  { label: 'Patient (Somchai)', email: 'somchai@example.com', password: 'demo1234' },
  { label: 'VIP (Alice)', email: 'alice@example.com', password: 'demo1234' },
  { label: 'VIP (John)', email: 'john.doe@example.com', password: 'demo1234' },
  { label: 'Doctor (Alice Smith)', email: 'alice.smith@mediconnect.app', password: 'demo1234' },
  { label: 'Admin', email: 'admin@mediconnect.app', password: 'demo1234' },
]
